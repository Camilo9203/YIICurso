        ...
        <div class="slick-container" data-autoplay="0" data-loop="1" data-speed="800" data-autoplay-timeout="1000" data-center="0" data-slides-per-view="1" data-fade-slide="1">
            <div class="slick-wrapper">
                <div class="slick-slide-in">
                    <div class="atf-single-home atf-hero-area" style="background-image: url(<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/banner/1.jpg);  background-size:cover; background-position: center center;">
                                ...
                                <div class="row atf-single-slide-sm2 atf-align-items-details align-items-center atf-single-text justify-content-center">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-12 text-center atf-single-details ">
                                        ...
                                        <div class="atf-main-btn mt-3">
                                            <a href="https://www.templatemonster.com/website-templates/al-majid-website-template-152091.html?_gl=1*1ley0u6*_ga*NDMyOTM1NTcxLjE2MTAxOTczNjQ.*_ga_FTPYEGT5LY*MTYxMDI4NzgyNS4zLjAuMTYxMDI4NzgzMS41NA..&_ga=2.145900727.2005536284.1610210101-432935571.1610197364" class="page-scroll atf-themes-btn mr-4">Pro Version <i class="fa fa-angle-right"></i></a>
                ...
                <div class="slick-slide-in">
                    <div class="atf-single-home atf-hero-area" style="background-image: url(<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/banner/3.jpg);  background-size:cover; background-position: center center;">
                        <div class="atf-home-overlay">
                            <div class="container">
                                <div class="row atf-single-slide-sm2 atf-align-items-details align-items-center atf-single-text justify-content-center">
                                    <!--LEFT COL-->
                ...
                <div class="slick-slide-in">
                    <div class="atf-single-home atf-hero-area" style="background-image: url(<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/banner/2.jpg);  background-size:cover; background-position: center center;">
                        <div class="atf-home-overlay">
                            <div class="container">
                                <div class="row atf-single-slide-sm2 atf-align-items-details align-items-center atf-single-text justify-content-center">
                                    <!--LEFT COL-->
        ...
        <div class="row">
            <div class="col-xl-7 col-lg-6 col-12 text-left">
                ...
                <div class="atf-main-btn mt-5 pb-5 d-lg-block">
                    <a href="" class="page-scroll atf-themes-btn">Contacto <i class="fa fa-angle-right"></i></a>
                </div>
            </div><!--- END COL -->
            ...
            <div class="col-xl-5 col-lg-6 col-12">
                <div class="atf-special-img text-center  mx-auto my-auto">
                    <div class="atf-single-special-img">
                        <img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/special.png" width="370" alt="Offer Image" class="img-fluid">
                    </div>
                </div>
            </div>	<!--- END COL -->
        </div><!--- END ROW -->
                    ...
                    <div class="slick-wrapper">
                        <div class="slick-slide-in">
                            <div class="atf-brand-active">
                                <a href="#"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/partner/1.png" alt="image"></a>
                            </div>
                        </div><!-- .slick-slide-in -->

                        <div class="slick-slide-in">
                            <div class="atf-brand-active">
                                <a href="#"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/partner/2.png" alt="image"></a>
                            </div>
                        </div><!-- .slick-slide-in -->

                        <div class="slick-slide-in">
                            <div class="atf-brand-active">
                                <a href="#"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/partner/3.png" alt="image"></a>
                            </div>
                        </div><!-- .slick-slide-in -->
                        <div class="slick-slide-in">
                            <div class="atf-brand-active">
                                <a href="#"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/partner/4.png" alt="image"></a>
                            </div>
                        </div><!-- .slick-slide-in -->
                        <div class="slick-slide-in">
                            <div class="atf-brand-active">
                                <a href="#"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/partner/5.png" alt="image"></a>
                            </div>
                        </div><!-- .slick-slide-in -->
